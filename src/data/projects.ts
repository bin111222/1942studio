...
export const projects: Project[] = [
  ...
  },
  {
    ...
    fullDescription: "HKS Clinic's digital transformation project focuses on streamlining patient experiences and information access.",
    image: "/images/portfolio/hks-clinic.png",
    gradient: "from-blue-600 to-purple-600",
    tags: ["Web Development", "Pre-consultation tests", "Ease of access"],
    link: "/portfolio/hks-clinic",
    challenges: [
      "Develop a unique digital identity to create a visually captivating website that appeals to an audience looking for high-end aesthetic services",
      "Provide user-friendly navigation that ensures a smooth and intuitive experience, allowing easy access to service details, qualifications, and client testimonials",
"Establish brand trust and authority by showcasing credentials, expertise, and professional accomplishments to build credibility",
"Leverage advanced technology with innovative elements such as AI-driven chatbots to elevate customer service and engagement",
    ],
    solutions: [
      {
